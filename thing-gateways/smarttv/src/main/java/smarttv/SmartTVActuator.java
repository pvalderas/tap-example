...
import smarttv.results.*;

@RestController
public class SmartTVActuator {
	...
	public String turnon(){
		String result ="";
/*
		result=restClient.get().uri("https://smarttv.example.com/on").retrieve().body(String.class);
*/
	...
	public String turnoff(){
		String result ="";
/*
		result=restClient.get().uri("https://smarttv.example.com/off").retrieve().body(String.class);
*/
	...
	public String setstatus(String input){
		String result ="";
/*
		result=restClient.post().uri("https://smarttv.example.com/status").contentType(MediaType.APPLICATION_JSON).body(input).retrieve().toBodilessEntity();
*/
	...
	public String getstatus(){
		String result ="";
/*
		result=restClient.get().uri("https://smarttv.example.com/status").retrieve().body(String.class);
*/
