package es.upv.pros.pvalderas.odrl.manager;
...
public class ODRLManager {
	...
	public static ODRLManager getCurrentInstance(){
		if(instance==null) instance=new ODRLManager();
		return instance;
	}
	
	private static ODRLManager instance;
	private ODRLManager(){};
